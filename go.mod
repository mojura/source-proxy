module github.com/mojura/source-proxy
...
require (
	...
	github.com/vroomy-ext/digitalocean-s3-plugin v0.5.3
...
require (
	...
	github.com/mojura/mojura v0.17.4 // indirect
	github.com/mojura/sync-s3 v0.5.1 // indirect
